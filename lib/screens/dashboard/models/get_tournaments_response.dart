class GetTournamentsResponse {
  int? code;
  TournamentDetails? tournamentsDetail;
  bool? success;

  GetTournamentsResponse({this.code, this.tournamentsDetail, this.success});

  GetTournamentsResponse.fromJson(Map<String, dynamic> json) {
    code = json["code"];
    tournamentsDetail =
        json["data"] == null ? null : TournamentDetails.fromJson(json["data"]);
  ...
  Map<String, dynamic> toJson() {
    ...
    data["code"] = code;
    if (tournamentsDetail != null) {
      data["data"] = tournamentsDetail?.toJson();
    }
...
class TournamentDetails {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (tournamentList != null) {
      data["tournaments"] = tournamentList?.map((e) => e.toJson()).toList();
    }
